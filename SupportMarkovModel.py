...
def print_outcomes(simOutput, therapy_name):
    ...
    print("  Estimate of mean and {:.{prec}%} confidence interval of discounted total cost:".format(1 - Settings.ALPHA, prec=0),
          cost_mean_CI_text)
    print("  Estimate of mean and {:.{prec}%} confidence interval of discounted total utility:".format(1 - Settings.ALPHA, prec=0),
...
def draw_survival_curves_and_histograms(simOutputs_mono, simOutputs_combo):
    ...
    PathCls.graph_sample_paths(
        ...
        legends=['No Drug', 'Anticoagulation Therapy']
    )
    ...
    Figs.graph_histograms(
        ...
        y_label='Counts',
        bin_width=1,
        legend=['No Drug', 'Anticoagulation Therapy'],
        transparency=0.6
    )
...
def print_comparative_outcomes(simOutputs_mono, simOutputs_combo):
    ...
    increase_strokecount = Stat.DifferenceStatIndp(
            name='Increase in number of stroke',
    ...
    print("Average increase in discounted total cost "
          "and {:.{prec}%} confidence interval:".format(1 - Settings.ALPHA, prec=0),
          estimate_CI)
    ...
    estimate_CI = F.format_estimate_interval(
        ...
        deci=2)
    print("Average increase in discounted total utility "
          "and {:.{prec}%} confidence interval:".format(1 - Settings.ALPHA, prec=0),
          estimate_CI)
